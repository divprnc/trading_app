...
import 'package:trading/Screens/shoping/Transition/Scale.dart';
import 'package:trading/Screens/shoping/Util/Helper.dart';
import 'package:trading/Screens/shoping/Util/config.dart';
import 'package:trading/Screens/shoping/Widget/list.dart';
import 'package:trading/Screens/shoping/cart.dart';
          ...
          children: <Widget>[
            SingleChildScrollView(
                ...
                children: <Widget>[
                  ...
                  //         child: Image.asset(
                  //           'assets/images/shop/profile.png',
                  //           width: 50,
                  //           height: 50,
                  //         ),
                  //       ),
                          ...
                          itemBuilder: (context,index){
                            return Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Card(
                                  elevation: 2,
                                  color: index == _selected ? Colors.teal : Colors.white,
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        '${_category[index]}',
                                        style: TextStyle(
                                          color: index ==  _selected ? Colors.white : Colors.teal,
