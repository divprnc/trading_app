...
class OtpPageState extends State<OtpPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      appBar: AppBar(title: Text("Enter OTP"), backgroundColor: Colors.blueGrey.shade900,),
              ...
              child: Row
                ...
                children: <Widget>[
                  ...
                  MaterialButton
                    ...
                    , child: Text("1", style
                        : TextStyle(color: Colors.white, fontSize: 25.0, fontWeight: FontWeight
              ...
              child: Row(
                ...
                <Widget>[
                  ...
                  MaterialButton(onPressed: () {
                    ...
                    , child: Text("5", style
                        : TextStyle(fontSize: 25.0,color: Colors.white, fontWeight: FontWeight
                        .w400), textAlign: TextAlign.center)
                    ,),
